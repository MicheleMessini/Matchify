...
res.status(status).send(`     <html>       <head><title>Errore</title><link rel="stylesheet" href="/styles.css"></head>       <body>         <div class="container">           <h2>❌ Errore</h2>           <p>${message}</p>           <a href="/" class="btn btn-secondary">Torna alla home</a>         </div>       </body>     </html>
  `);
}
